...
const zh: Messages = {
  ...
  updateNotesBtn: "更新說明",
  updateNotesTitle: "2026年8月16日 更新內容",
  updateNotesClose: "知道了",
  updateNotesItems: [
    "★5 低綻放技能描述改為綻放文案庫：中文句式與滿綻角色名片一致，僅數值隨綻 0–5 變化",
    "修正多張卡 SP 發動率條件（期生／Combo／Life）解析與低綻顯示",
    "修正被動技能重複「若編入…2名…」等描述問題",
...
const en: Messages = {
  ...
  updateNotesTitle: "Aug 16, 2026 update",
  updateNotesClose: "Got it",
  updateNotesItems: [
    "★5 low-bloom skill text now uses bloom text library: same zh wording as max-bloom catalog, numbers only change by stage 0–5",
    "Fixed SP skill-rate conditions (unit / Combo / Life) parse & low-bloom display",
    "Fixed duplicate passive condition prefix in skill descriptions",
...
const ja: Messages = {
  ...
  updateNotesBtn: "更新内容",
  updateNotesTitle: "2026年8月16日 更新",
  updateNotesClose: "閉じる",
  updateNotesItems: [
    "★5低開花スキル文を開花文案庫に：満開名片と同じ中文、数値のみ0–5で変化",
    "SP発動率条件（期生／Combo／Life）の解析と低開花表示を修正",
    "パッ説明の条件重複を修正",
